...
<div class="page-enter pt-32 pb-28 px-6 lg:px-10 flex justify-center min-h-[80vh] items-center">
  <div class="w-full max-w-md">
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-8 reveal" style="transition-delay: 200ms">
      @csrf
      
      <div class="relative group">
        <label for="name" class="mono text-[10px] tracking-[0.25em] text-ink/50 uppercase absolute -top-2 left-0 transition-all group-focus-within:text-velora group-focus-within:-top-4">FULL NAME</label>
        <input id="name" type="text" name="name" class="w-full bg-transparent border-b border-ink/20 focus:border-ink outline-none py-3 text-[16px] transition-colors" required autofocus autocomplete="name" />
      </div>
      ...
      <div class="relative group">
        ...
        <input id="email" type="email" name="email" class="w-full bg-transparent border-b border-ink/20 focus:border-ink outline-none py-3 text-[16px] transition-colors" required autocomplete="email" />
      </div>
      ...
      <div class="relative group">
        <label for="password_confirmation" class="mono text-[10px] tracking-[0.25em] text-ink/50 uppercase absolute -top-2 left-0 transition-all group-focus-within:text-velora group-focus-within:-top-4">CONFIRM PASSWORD</label>
